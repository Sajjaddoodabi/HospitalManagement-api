...
urlpatterns = [
    ...
    path('prescription/add-prescription/add-medicine-to-prescription/', AddMedicineToPrescription.as_view()),
    path('prescription/add-prescription/add-medicine/', AddMedicine.as_view()),
